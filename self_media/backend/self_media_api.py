...
from self_media.backend.config import settings, LLMConfig, LLMProvider
from self_media.backend.definitions import skill_registry
from self_media.backend.engine import create_workflow_engine, WorkflowEngine
from self_media.backend.llm_client import get_llm_client
...
class SelfMediaRouter:
    ...
    def setup_routes(self):
        ...
        @self.app.get("/api/self_media/skills")
        ...
        @self.app.get("/api/self_media/skills/{skill_id}")
        ...
        @self.app.post("/api/self_media/workflow/run")
        ...
        @self.app.post("/api/self_media/skill/execute")
        ...
        @self.app.post("/api/self_media/config/validate")
        ...
        @self.app.get("/api/self_media/health")
